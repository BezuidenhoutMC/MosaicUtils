...
class Tiling(object):
	...
	#Tiaan Mod
	print("Radius of primary beam: "+ str(self.tiling_radius)+" deg")
    ...
    def plot_sky_pattern(self, filename):
        """
        plot the sky pattern with specified filename
...
def generate_nbeams_tiling(beam_shape, beam_num, overlap = 0.5, margin=None):
    ...
    logger.info("tiling: angle: {:.4g} deg ".format(beam_shape.angle))
    return tiling_obj
